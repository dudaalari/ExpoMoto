...
O **ExpoMoto** é uma Landing Page moderna e responsiva desenvolvida com foco em **SEO (Search Engine Optimization)** e boas práticas de Front-end. O projeto simula a página de uma cafeteria fictícia, apresentando produtos, receitas e novidades.
...
Durante o desenvolvimento, foram aplicados os seguintes conceitos técnicos:
  ...
  **JavaScript Básico:** Manipulação do DOM para interatividade do menu responsivo (Efeito Toggle).
